...
/* ---- box for image separator ---- */
	...
	gtk_grid_attach(GTK_GRID(grid), box_2, 1, 0, 1, 15);
...
/* ---- box in grid for buttons ---- */
	...
	gtk_grid_attach(GTK_GRID(grid), box_3, 6, 0, 1, 15);
	...
	gtk_widget_set_halign(name_color, GTK_ALIGN_END);
	...
	gtk_grid_attach(GTK_GRID(grid), name_iterations, 6, 1, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), name_offset_x, 6, 4, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), name_offset_y, 6, 7, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), name_zoom, 6, 10, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), name_color, 6, 12, 1, 1);
...
/* ---- text entry with placeholder text ---- */
	...
	gtk_grid_attach(GTK_GRID(grid), local_data->input_iterations, 6, 2, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), local_data->input_offset_x, 6, 5, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), local_data->input_offset_y, 6, 8, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), local_data->input_zoom, 6, 11, 1, 1);
...
/*	*/
/*	gtk_grid_attach(GTK_GRID(grid), sep_iterations, 6, 0, 1, 1);*/
/*	gtk_grid_attach(GTK_GRID(grid), sep_offset_x, 6, 3, 1, 1);*/
/*	gtk_grid_attach(GTK_GRID(grid), sep_offset_y, 6, 6, 1, 1);*/
/*	gtk_grid_attach(GTK_GRID(grid), sep_zoom, 6, 9, 1, 1);*/
